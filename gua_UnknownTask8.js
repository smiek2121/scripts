...
async function run(){
  try{
    ...
    $.beans = 0
    $.flag = true
    if($.beans > 0) message += `【京东账号${$.index}】获得 ${$.beans}京豆\n`
...
function receive() {
  return new Promise(resolve => {
    let options = {
      url: `https://ms.jr.jd.com/gw/generic/hy/h5/m/drawNewMemberRights1?reqData={"appCode":"jr-vip","version":"2.0","rid":2022,"drawEnv":"H5"}`,
      headers: {
