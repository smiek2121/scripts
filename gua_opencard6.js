...
function getHtml() {
  return new Promise(resolve => {
    $.get({
      url: `https://prodev.m.jd.com/mall/active/4TUq5NiJL2QnGsbnCemJ2UUsaa9R/index.html`,
      headers: {
...
async function getUA(){
  ...
  let arr = await Faker.getBody($.UA,'https://prodev.m.jd.com/mall/active/4TUq5NiJL2QnGsbnCemJ2UUsaa9R/index.html')
  $.fp = arr.fp
  await getEid(arr)
}
